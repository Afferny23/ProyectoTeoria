...
void CFiguras::prismaRep(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prismaRep3(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
...
void CFiguras::prismaRep2(float altura, float largo, float profundidad, GLuint text)  //Funcion creacion prisma
{
	...
	glTexCoord2f(1.0f, 2.0f); glVertex3fv(vertice[7]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[1]);
	glEnd();
	...
	glTexCoord2f(10.0f, 2.0f); glVertex3fv(vertice[5]);
	glTexCoord2f(0.0f, 2.0f); glVertex3fv(vertice[4]);
	glEnd();
	...
	glTexCoord2f(10.0f, 2.0f); glVertex3fv(vertice[7]);
	...
	glTexCoord2f(20.0f, 1.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(0.0f, 1.0f); glVertex3fv(vertice[3]);
	glEnd();
